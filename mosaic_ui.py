...
class MosaicUI:
    ...
    def setup_ui(self):
        ...
        self.canvas.grid(row=0, column=0, padx=10, sticky=(tk.W, tk.N))
        self.canvas.grid_propagate(False)  # サイズを固定
        ...
        display_frame.columnconfigure(0, weight=0)  # 左寄せのため重みを0に
        display_frame.columnconfigure(1, weight=0)  # パラメータ側も重みを0に
